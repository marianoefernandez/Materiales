...
void mostrarEmpleado(eSector sectores [], eEmpleado emp);
...
void obtenerSector (eSector sectores [], int tam, int id, char descripcion []);
...
{
    char sector
    printf("  %d   %s   %c    %.2f\n %s", emp.legajo, emp.nombre, emp.sexo, emp.sueldo,sectores.descripcion);

}

void mostrarEmpleados(eEmpleado vec[], int tam, char)
{
    int cont= 0;
